 ...
 <nav class="navbar navbar-inverse">
        <div class="container-fluid">
		  ...
		  <li> <a href="http://localhost/ooredoo/index.html"> <span class="glyphicon glyphicon-home" aria-hidden="true"> </span>  Accueil</a> </li>
            <li class="active"> <a href="list_demande.php"> <span class="glyphicon glyphicon-user" aria-hidden="true"> </span>  Liste des demandes </a> </li>
            <li> <a href="affiche_emp.php"> <span class="glyphicon glyphicon-user" aria-hidden="true"> </span>  Liste des Employers (Accepté) </a> </li>           
...
<table class="table table-striped" style="border-width:1px;border-color:black;" >  
   ...
   <td> <?php echo $donnees["num_tele"]; ?> </td>
   <td> <?php echo $donnees["mail"]; ?> </td>
   <td> <?php echo $donnees["cin"]; ?> </td>
   <td> <?php echo $donnees["pwd"]; ?> </td>   
   <td> 
   
<a style="text-decoration: none"  href="list_employer.php?id=<?php echo $donnees["id"]; ?>" >
<button type="submit"class="btn btn-success" name="b1">
<span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a>

	
<a style="text-decoration: none" class="confirmModalLink" href="supp_demande.php?id=<?php echo $donnees["id"]; ?>"> 
